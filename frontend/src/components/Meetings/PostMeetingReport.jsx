...
import { ArrowLeft, Download, Users, UserCheck, UserX, Clock, Percent, AlertTriangle } from "lucide-react";
...
const PostMeetingReport = ({ embedded = false, basePath = "/meetings" }) => {
  ...
  return (
    <div className={embedded ? "meeting-page meeting-page-embedded" : "meeting-page"}>
      ...
      <div className="meeting-report-footer">
